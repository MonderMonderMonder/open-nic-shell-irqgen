...
module box_250mhz_address_map #(
  ...
  output        m_axil_girq_awvalid,
  output [31:0] m_axil_girq_awaddr,
  input         m_axil_girq_awready,
  output        m_axil_girq_wvalid,
  output [31:0] m_axil_girq_wdata,
  input         m_axil_girq_wready,
  input         m_axil_girq_bvalid,
  input   [1:0] m_axil_girq_bresp,
  output        m_axil_girq_bready,
  output        m_axil_girq_arvalid,
  output [31:0] m_axil_girq_araddr,
  input         m_axil_girq_arready,
  input         m_axil_girq_rvalid,
  input  [31:0] m_axil_girq_rdata,
  input   [1:0] m_axil_girq_rresp,
  output        m_axil_girq_rready,
  ...
  localparam C_GIRQ_INDEX = NUM_INTF*2; // what is NUM_INTF?

  localparam C_P2P_BASE_ADDR = 32'h0;
  localparam C_SIZE = 32'h80;
  localparam C_GIRQ_BASE_ADDR = 32'h1000;
  ...
  assign m_axil_girq_awvalid               = axil_awvalid[C_GIRQ_INDEX];
  assign m_axil_girq_awaddr                = axil_awaddr[C_GIRQ_INDEX*32 +: 32] - C_GIRQ_BASE_ADDR;
  assign axil_awready[C_GIRQ_INDEX]        = m_axil_girq_awready;
  assign m_axil_girq_wvalid                = axil_wvalid[C_GIRQ_INDEX];
  assign m_axil_girq_wdata                 = axil_wdata[C_GIRQ_INDEX*32 +: 32];
  assign axil_wready[C_GIRQ_INDEX]         = m_axil_girq_wready;
  assign axil_bvalid[C_GIRQ_INDEX]         = m_axil_girq_bvalid;
  assign axil_bresp[C_GIRQ_INDEX*2 +: 2]   = m_axil_girq_bresp;
  assign m_axil_girq_bready                = axil_bready[C_GIRQ_INDEX];
  assign m_axil_girq_arvalid               = axil_arvalid[C_GIRQ_INDEX];
  assign m_axil_girq_araddr                = axil_araddr[C_GIRQ_INDEX*32 +: 32] - C_GIRQ_BASE_ADDR;
  assign axil_arready[C_GIRQ_INDEX]        = m_axil_girq_arready;
  assign axil_rvalid[C_GIRQ_INDEX]         = m_axil_girq_rvalid;
  assign axil_rdata[C_GIRQ_INDEX*32 +: 32] = m_axil_girq_rdata;
  assign axil_rresp[C_GIRQ_INDEX* 2 +: 2]  = m_axil_girq_rresp;
  assign m_axil_girq_rready                = axil_rready[C_GIRQ_INDEX];
