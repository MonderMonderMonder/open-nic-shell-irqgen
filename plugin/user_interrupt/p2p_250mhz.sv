...
module p2p_250mhz #(
  ...
  input                         s_axil_girq_awvalid,
  input                  [31:0] s_axil_girq_awaddr,
  output                        s_axil_girq_awready,
  input                         s_axil_girq_wvalid,
  input                  [31:0] s_axil_girq_wdata,
  output                        s_axil_girq_wready,
  output                        s_axil_girq_bvalid,
  output                 [1:0]  s_axil_girq_bresp,
  input                         s_axil_girq_bready,
  input                         s_axil_girq_arvalid,
  input                  [31:0] s_axil_girq_araddr,
  output                        s_axil_girq_arready,
  output                        s_axil_girq_rvalid,
  output                 [31:0] s_axil_girq_rdata,
  output                  [1:0] s_axil_girq_rresp,
  input                         s_axil_girq_rready,
...
`endif
  ...
  generate for (genvar i = 0; i < NUM_INTF; i++) begin
    ...
    if (NUM_QDMA > 1) begin
      ...
      girq_axil_wrapper girq_axil_wrapper_inst (
        ...
        .s_axil_girq_awvalid (s_axil_girq_awvalid),
        .s_axil_girq_awaddr  (s_axil_girq_awaddr),
        .s_axil_girq_awready (s_axil_girq_awready),
        .s_axil_girq_wvalid  (s_axil_girq_wvalid),
        .s_axil_girq_wdata   (s_axil_girq_wdata),
        .s_axil_girq_wready  (s_axil_girq_wready),
        .s_axil_girq_bvalid  (s_axil_girq_bvalid),
        .s_axil_girq_bresp   (s_axil_girq_bresp),
        .s_axil_girq_bready  (s_axil_girq_bready),
        .s_axil_girq_arvalid (s_axil_girq_arvalid),
        .s_axil_girq_araddr  (s_axil_girq_araddr),
        .s_axil_girq_arready (s_axil_girq_arready),
        .s_axil_girq_rvalid  (s_axil_girq_rvalid),
        .s_axil_girq_rdata   (s_axil_girq_rdata),
        .s_axil_girq_rresp   (s_axil_girq_rresp),
        .s_axil_girq_rready  (s_axil_girq_rready),
